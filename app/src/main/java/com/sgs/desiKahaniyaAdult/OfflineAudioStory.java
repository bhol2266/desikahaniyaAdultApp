...
//NO BANNER AD IN STORY LIST
    ...
    private void loadSavedAudioFiles() {
        ...
        for (int i = 0; i < name_array.size(); i++) {
            com.sgs.desiKahaniyaAdult.AudioOfflineModel model = new com.sgs.desiKahaniyaAdult.AudioOfflineModel(name_array.get(i), path_array.get(i));
...
class OfflineAudioAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        com.sgs.desiKahaniyaAdult.AudioOfflineModel model = (com.sgs.desiKahaniyaAdult.AudioOfflineModel) collectionData.get(holder.getAdapterPosition());
