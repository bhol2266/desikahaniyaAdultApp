            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                ...
                switch (menuItem.getItemId()) {
                    ...
                    case R.id.Privacy_Policy:
                        ...
                        i5.setData(Uri.parse("https://www.ukdevelopers.org/desikahani/privacypolicy"));
                        startActivity(i5);
                        drawerLayout.closeDrawer(GravityCompat.START);
                        break;
        ...
        request.addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                flow.addOnCompleteListener(task1 -> {
                    // The review flow is finished.
                    // The API does not tell you if the user submitted a review or not.
                });
            } else {
                // Handle the error (e.g., log or show fallback UI)
            }
        });
    }
